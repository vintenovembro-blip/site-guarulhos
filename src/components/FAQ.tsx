...
const faqs = [
  { question: "O cursinho realmente é gratuito?",                          answer: "Sim, 100% gratuito! Não há mensalidades, taxas de matrícula ou cobranças por materiais. Acreditamos que todo jovem merece acesso a uma preparação de qualidade, independentemente da situação financeira." },
  { question: "Para quem é o cursinho Sua Chance?",                        answer: "Para qualquer jovem que deseja se preparar para o Vestibulinho da ETEC ou para o ENEM. Seja você do 1°, 2° ou 3° ano do Ensino Médio, ou já formado, o Sua Chance tem espaço para você." },
  { question: "Como funcionam as aulas?",                                  answer: "As aulas são ministradas por professores dedicados, cobrindo todas as disciplinas cobradas no Vestibulinho da ETEC e no ENEM. Após se inscrever, você receberá todos os detalhes sobre horários e formato das aulas." },
  { question: "Qual é o diferencial do Sua Chance?",                      answer: "Além de ser gratuito, oferecemos material didático exclusivo, simulados no formato das provas, plantão de dúvidas, grupo de alunos para estudo em comunidade e acompanhamento personalizado." },
  { question: "Quando começa a próxima turma?",                            answer: "As turmas têm início periódico ao longo do ano. Ao se inscrever no formulário, você ficará na lista de espera e será o primeiro a saber quando abrirmos novas vagas. Inscreva-se agora para garantir sua vaga!" },
  { question: "Preciso ter algum nível de conhecimento para participar?",  answer: "Não! O cursinho foi pensado para atender todos os níveis, do básico ao avançado. Os professores explicam os conteúdos desde o início, garantindo que todos acompanhem." },
  { question: "Como é o material de estudos?",                            answer: "Você receberá material didático completo cobrindo todos os conteúdos, além de listas de exercícios, simulados e gabaritos comentados — tudo pensado para maximizar seu aprendizado." },
];
      ...
      <div className="container-inner">
        ...
        <div className="section-header">
          ...
          <motion.h2 initial={{ opacity: 0, y: reduce ? 0 : 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: .45, delay: .08 }}
            ...
            Ficou com{" "}
            <span style={{ color: "#2563eb" }}>dúvidas?</span>
          </motion.h2>
          <motion.p initial={{ opacity: 0, y: reduce ? 0 : 12 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: .45, delay: .15 }}
            ...
            Respondemos as perguntas mais comuns aqui.
          </motion.p>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: reduce ? 0 : 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: .45, delay: .6 }}
          ...
          <p style={{ color: "#2563eb", fontWeight: 600, fontSize: ".9rem", marginBottom: ".25rem" }}>Ainda tem alguma dúvida?</p>
          <p style={{ color: "#64748b", fontSize: ".8rem", marginBottom: "1rem" }}>Entre em contato pelo WhatsApp e respondemos rapidinho!</p>
          <a href="https://wa.me/5511999999999?text=Ol%C3%A1!%20Tenho%20uma%20d%C3%BAvida%20sobre%20o%20Cursinho%20Sua%20Chance." target="_blank" rel="noopener noreferrer"
